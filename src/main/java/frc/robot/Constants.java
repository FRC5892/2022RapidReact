...
public final class Constants {
	...
	public static final double[] FLYWHEEL_PID_CONSTANTS = new double[] { 0.000155, 0, 0 };
	// public static final double[] FLYWHEEL_PID_CONSTANTS = new double[] { 0.0001538*60, 0, 0 };
    public static final double[] FLYWHEEL_SPARKMAX_PID = new double[] { 0.000155, 0.000013, 0 };
