...
public class AutonSetup1 extends SequentialCommandGroup {
	...
	public AutonSetup1(Flywheel f, Turret t, Hood h, Tower tw, Kicker k, TurretVision tv,
		...
		addCommands(new InstantCommand(i::openPistons, i), new AutonDriveAndIntake(f, t, h, tw, k, tv, dt, i), new InstantCommand(i::closePistonsdelayed, i), new RotateRobot2(dt, 160), new AimAndShoot(f, t, h, tw, k, tv, dt));
